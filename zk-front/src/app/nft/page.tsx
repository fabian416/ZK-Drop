      ...
      <div className="container max-w-lg px-4">
        ...
        <Card className="p-6 border-2 border-[#c1ff72]/40 mx-auto">
          <div className="flex items-center mb-6 justify-center">
            ...
            <div>
              <h1 className="text-2xl font-bold text-[#453978]">NFT Drop</h1>
              <div className="flex items-center">
                <span className="bg-[#c1ff72] text-[#453978] font-medium mr-2 rounded-full px-2 py-1 text-xs">
                  {nftData.region}
                </span>
                <span className="text-sm text-gray-500">Unique zk-powered identity NFTs</span>
              </div>
            </div>
          </div>
          ...
          {!isClaimed ? (
            ...
            <div className="text-center py-6">
              ...
              <h2 className="text-xl font-bold text-[#453978] mb-2">NFT Claimed!</h2>
              <p className="text-gray-600 mb-6">
                You have successfully claimed {nftData.nftName} from the regional airdrop.
              </p>
              <Link href="/dashboard">
